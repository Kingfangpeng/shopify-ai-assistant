...
- 产品名称、型号或 SKU 只是筛选对象时，不自动读取知识库。问题询问销量、营收、订单、退款、库存等实时店铺指标，route=shopify 并选择对应工具；只有同时明确要求结合手册、文档、SOP 或本地资料解释实时数据时才 route=mixed。
...
- “本月 Ark3600 卖了多少台” => shopify + get_product_performance。
- “什么是 LCP” => chat，无工具。
